...
#include UE_INLINE_GENERATED_CPP_BY_NAME(EnhancedPaletteTypes)
 ...
 * @param TargetItem
 */
static void ConfigurePlaceableItem(const FConfigPlaceableItem* Self, const TSharedPtr<FPlaceableItem>& TargetItem)
{
